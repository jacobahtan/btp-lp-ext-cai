		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shell",
									"targetURL": "#btplpshellcai-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btplpshellcai-display": {
								"semanticObject": "btplpshellcai",
								"action": "display",
								"description": "Shell",
								"title": "Shell",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btplpshellcai",
									"url": sap.ui.require.toUrl("btplpshellcai")
								}
							}
						}
					}
